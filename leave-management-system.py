...
class AdminClass:      # Clerk
    ...
    def adminwindow(self):
        ...
        background_label = Label(adminmainwindow, bg="grey")
        background_label.place(x=1, y=10, relwidth=1, relheight=1)
        
        informationEmployee = Button(adminmainwindow, text = 'All Employee information', command = self.EmployeeAllInformationWindow, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 36, "bold"), activebackground = "yellow")
        informationEmployee.pack(fill=X)

        LeaveListButton = Button(adminmainwindow, text = 'Leave approval list', command = self.leavelist, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 36, "bold"), activebackground = "yellow")
        LeaveListButton.pack(fill=X)

        ApprovalButton = Button(adminmainwindow, text = 'Approve leave', command = self.LeaveApproval, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 36, "bold"), activebackground = "yellow")
        ApprovalButton.pack(fill=X)

        LogoutBtn = Button(adminmainwindow, text = 'Logout', command = adminmainwindow.destroy, bd=12, relief=GROOVE, fg="red",bg="grey",font=("Calibri", 36, "bold"), activebackground = "yellow")
    ...
    def EmployeeAllInformationWindow(self):
        ...
        tree.column("one", anchor = 'c', minwidth = 0, width =200 )
        tree.column("two", anchor = 'c', minwidth = 0, width = 200)
        tree.column("three", anchor = 'c', minwidth = 0, width =200)
        tree.column("four", anchor = 'c', minwidth = 0, width = 200)
        tree.column("five", anchor = 'c', minwidth = 0, width = 200)
        tree.column("six", anchor = 'c', minwidth = 0, width = 200)
    ...
    def leavelist(self):
        ...
        tree.column('one', anchor = 'c', minwidth=0, width=130)
        tree.column('two', anchor = 'c', minwidth=0, width=130)
        tree.column('three', anchor = 'c', minwidth=0, width=130)
        tree.column('four', anchor = 'c', minwidth=0, width=130)
        tree.column('five', anchor = 'c', minwidth=0, width=130)
        tree.column('six', anchor = 'c', minwidth=0, width=130)
        tree.column('seven', anchor = 'c', minwidth=0, width=130)
        tree.column('eight', anchor = 'c', minwidth=0, width=130)
...
class EmployeeClass:        # Employee 
    ...
    def EmployeeLoginWindow(self):
        ...
        background_label = Label(LoginWindow, bg="grey")
        background_label.place(x=1, y=10, relwidth=1, relheight=1)
                                                                    
        informationEmployee = Button(LoginWindow, text = 'Employee information', command = self.EmployeeInformationWindow, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        informationEmployee.pack(fill=X)

        submit = Button(LoginWindow, text = 'Submit Leave', command = self.apply, bd=12, relief = GROOVE, fg = "black", bg = "grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        submit.pack(fill=X)

        LeaveBalance = Button(LoginWindow, text= 'Leave Balance', command = self.balance, bd = 12, relief = GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        LeaveBalance.pack(fill=X)

        LeaveApplicationStatus = Button(LoginWindow, text= 'Last leave status', command = self.EmployeeLeaveStatus, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        LeaveApplicationStatus.pack(fill=X)

        AllLeaveStatus = Button(LoginWindow, text='All leave status', command = self.EmployeeAllStatus, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        AllLeaveStatus.pack(fill=X)

        LogoutBtn = Button(LoginWindow, text = 'Logout', command= LoginWindow.destroy, bd=12, relief=GROOVE, fg="red", bg="grey", font=("Calibri", 30, "bold"), activebackground = "yellow")
        LogoutBtn.pack(fill=X)
    ...
    def apply(self):
        ...
        if str(date3) == fieldValues[2]:
            ...
            choice = choicebox(message1, title1, choices)
            leaveid = random.randint(100, 10000)
    ...
    def EmployeeAllStatus(self):
        ...
        tree.column('eight', anchor = 'c', minwidth = 0, width = 150)
...
class update_info_class:        # Update information of employee
    ...
    def UpdateWindow(self):
        ...
        background_label = Label(UpdateWindow, bg="sky blue")
        background_label.place(x=1, y=10, relwidth=1, relheight=1)

        informationEmployee = Button(UpdateWindow, text = 'Employee information', command = self.Employee_Information_Window, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        informationEmployee.pack(fill=X)

        updatename = Button(UpdateWindow, text = 'Update Name', command= self.update_name, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 36, "bold"), activebackground = "yellow")
        updatename.pack(fill=X)

        updatephonenumber = Button(UpdateWindow, text = 'Update Phone Number', command = self.update_Phone_Number, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        updatephonenumber.pack(fill=X)

        changepassword = Button(UpdateWindow, text = 'Change Password', command = self.change_password, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        changepassword.pack(fill=X)
        
        updatemail = Button(UpdateWindow, text = 'Update Mail ID', command = self.update_Emp_mail, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        updatemail.pack(fill=X)

        updateaddress = Button(UpdateWindow, text = 'Update Address', command = self.update_Emp_address, bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), activebackground = "yellow")
        updateaddress.pack(fill=X)

        LogoutBtn = Button(UpdateWindow, text = 'Logout', command = self.Employeelogout, bd=12, relief=GROOVE, fg="red", bg="grey", font=("Calibri", 30, "bold"), activebackground = "yellow")
        LogoutBtn.pack(fill=X)
...
class RegistrationClass:        # Employee registration class
        ...
        def registration(self):
            ...
            registerid = random.randint(100,100000)
...
background_label = Label(root, bg="Sky blue")
background_label.place(x=1, y=10, relwidth=1, relheight=1)

#define object to class
obj1 = AdminClass()
obj2 = EmployeeClass()
...
MainLabel = Label(root, text="Employee Leave Management System", bd=12, relief=GROOVE, fg="White", bg="purple",font=("Calibri", 60, "bold"))
MainLabel.pack()

AdminLgnBtn = Button(root, text='HR login',  bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), command=obj5.HRLogin, activebackground = "yellow")
AdminLgnBtn.pack(fill=X)

AdminLgnBtn = Button(root, text='Clerk login',  bd=12, relief=GROOVE, fg="black", bg="grey",font=("Calibri", 30, "bold"), command=obj1.AdminLogin, activebackground = "yellow")
AdminLgnBtn.pack(fill=X)
    
EmployeeRegistration = Button(root, text='Employee registration', command = obj4.registration, bd=12, relief=GROOVE, fg="black", bg="grey", font=("Calibri", 30, "bold"), activebackground = "yellow")
EmployeeRegistration.pack(fill=X)

LoginBtn = Button(root, text='Employee login', bd=12, relief=GROOVE, fg="black", bg="grey", font=("Calibri", 30, "bold"), command=obj2.EmployeeLogin, activebackground = "yellow")
LoginBtn.pack(fill=X)

updatebutton = Button(root, text = "Update Information", bd = 12, relief=GROOVE, fg="black", bg="grey", font=("Calibri", 30, "bold"), command = obj3.update_information, activebackground = "yellow")
updatebutton.pack(fill=X)

ExitBtn = Button(root, text='Exit', command=root.destroy, bd=12, relief=GROOVE, fg="red", bg="grey", font=("Calibri", 30, "bold"), activebackground = "yellow")
ExitBtn.pack(fill=X)
